...
# # Your __init__ method should receive a default argument for name.
# # # If the name is invalid, the setter method should print()
#  "Name must be string between 1 and 25 characters."
# # # Define a breed property for your Dog class. Your __init__ method
#  should receive a default argument for breed.
...
# # # approved_breeds = ["Mastiff", "Chihuahua", "Corgi", "Shar Pei", "Beagle", "French
class Dog:
